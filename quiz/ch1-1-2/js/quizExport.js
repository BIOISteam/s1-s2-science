...
export function downloadWord(questions, answersMode, lang) {
  ...
  const titleEn = answersMode
    ? "Ch 1 · 1.2 Distinguish variables — Answers"
    : "Ch 1 · 1.2 Distinguish variables — Questions";
  const titleZh = answersMode ? "第一章 1.2 分辨變數 — 答案" : "第一章 1.2 分辨變數 — 試題";
  ...
  a.download = (answersMode ? "ch1_1-2_answers_" : "ch1_1-2_questions_") + ts + ".doc";
  a.click();
