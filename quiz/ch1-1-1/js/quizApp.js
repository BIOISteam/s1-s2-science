...
const UI = {
  en: {
    appSubtitle: "Concept checks · English UI",
    ...
    revBandExcellent:
      "Overall accuracy is very high. Keep practising the stages of scientific investigation in order.",
    revBandGood: "Good result. Revisit any weaker stage labels, then regenerate.",
    revBandFair: "Mixed performance: re-read the plant growth scenario and match each action to its stage.",
    revBandLow:
      "Several stages need consolidation. Review Observation, Hypothesis, Experiment, Data analysis, and Conclusion before the next round.",
